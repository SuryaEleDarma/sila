...
<html lang="en">
  <head>
    ...
    <meta name="keyword" content="Dashboard, Bootstrap, Admin, Template, Theme, Responsive, Fluid, Retina">
     ...
     <title>BaliResto | MANAJER | Edit Pegawai</title>
            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" enctype="multipart/form-data" method="post" action="<?php echo base_url() . 'manajer_controller/updatePegawai';?>">
                        <input type="text" name="idid" value="<?php echo $key->ID ?>"hidden >
                              ...
                              <div class="col-sm-10">
                                  <select class="form-control" id="sel1" name="pekerjaan">
                                    ...
                                    <?php foreach ($pekerjaan as $key2) {
                                        if ($key2->PEKERJAAN == $key->PEKERJAAN) { ?>

                                        <option value="<?php echo $key2->IDP;?>" selected><?php echo $key2->PEKERJAAN;?></option>
                                      <?php 
                                    } else { ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="email;" name="email" value="<?php echo $key->EMAIL?>" class="form-control">
                              </div>
                          </div>  
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text;" name="telp" value="<?php echo $key->NO_TELP?>" class="form-control">
                              </div>
                          </div>                     
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <img width="100" src="<?php echo base_url().'image/foto/'.$key->PICT; ?>">

                              </div>
                          </div>

                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Letak File</label>
                              <div class="col-sm-10">
