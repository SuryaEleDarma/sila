                    ...
                    <div class="panel-heading">
                        ...
                        <div class="col-md-5" style="padding-top:0px;">
                          ...
                          <div class="panel-body">
                              ...
                              <a onclick="return confirmBayar('<?php echo $meja; ?>')" href="<?php echo site_url().'kasir_controller/bayar/'.$meja; ?>" class="btn btn-success btn-sm pull-right" style="margin-top:-36px;">Bayar</a>
                              <div class="pull-right" style="margin-top:-6px;color:red;">*Click untuk bayar</div>
